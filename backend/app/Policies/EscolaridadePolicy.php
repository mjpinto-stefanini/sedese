...
class EscolaridadePolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Escolaridade  $escolaridade
     * @return \Illuminate\Auth\Access\Response|bool
     */
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, Escolaridade $escolaridade)
    {
        //
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, Escolaridade $escolaridade)
    {
        //
    }
}
